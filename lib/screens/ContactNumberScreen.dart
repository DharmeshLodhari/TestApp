        ...
        child: Column(
          children: [
            Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  counterText: '',
                  suffixIcon: _controller.text.isEmpty? null: InkWell(
                      onTap: (){
                        _controller.text = '';
                        setState(() {});
                      },
            ...
            RoundButton(
                ...
                bgColor: pink, btnTextStyle: whiteText14, btnText: strSave, onTap: (){
                if(_controller.text.toString().length >= 8){
                  Navigator.pop(context, {'Number':_controller.text.toString(),});
                }
            })
          ],
        ),
