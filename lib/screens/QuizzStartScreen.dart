  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text(isQuizzCompleted ?'':strUserProfile,
   ...
   String _getInfoText(){
     return  isQuizzCompleted ? strQuizzCompleted.replaceFirst('__&&__',taskCompletePercentage):strCreateUserProfile;
   }
